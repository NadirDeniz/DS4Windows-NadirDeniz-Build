...
namespace DS4WinWPF.DS4Control.DTOXml
{
    ...
    public class AppSettingsDTO : IDTO<BackingStore>
    {
        ...
        //    get
        //    {
        //        return tempDoc.CreateComment(string.Format(" Made with APP version {0} ", Global.exeversion));
        //    }
        //    set { }
        //}
        ...
        [XmlIgnore]
        public bool UseExclusiveMode { get; private set; } = true;
        ...
        {
            // Invariant culture so profiles are portable across locales (e.g. tr-TR would otherwise
            // emit '.' as the date separator and parse dd/MM instead of MM/dd).
        ...
        [XmlIgnore]
        public bool LowLatencyInput
        {
            get; private set;
        } = InputLatencyPipeline.DEFAULT_LOW_LATENCY_INPUT;

        [XmlElement("LowLatencyInput")]
        public string LowLatencyInputString
        {
            get => LowLatencyInput.ToString();
            set
            {
                if (bool.TryParse(value, out bool temp))
                {
                    LowLatencyInput = temp;
                }
            }
        }
        ...
        public void MapFrom(BackingStore source)
        {
            ...
            LowLatencyInput = source.lowLatencyInputMode;
        ...
        public void MapTo(BackingStore destination)
        {
            ...
            destination.lowLatencyInputMode = LowLatencyInput;
