...
<Profile>
  ...
  <LowLatencyInput>True</LowLatencyInput>
  ...
  <CustomLed8>False:0,0,255</CustomLed8>
        ...
        public void CheckSettingsRead()
        {
            ...
            // Check settings (invariant parse so the test is deterministic across machine cultures)
            DateTime.TryParse(dto.LastCheckString, System.Globalization.CultureInfo.InvariantCulture,
                System.Globalization.DateTimeStyles.None, out DateTime tempLastChecked);
        ...
        public void CheckSettingsSave()
        {
            ...
            // Line-ending-agnostic so the inlined golden string is not sensitive to how the source
            // file was checked out (LF vs CRLF); XmlWriter always emits CRLF.
            Assert.AreEqual(NormalizeLineEndings(appSettingsXml), NormalizeLineEndings(testStr));
        }
