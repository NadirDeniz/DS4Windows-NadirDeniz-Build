...
using LEDBarMode = APP.DualSenseControllerOptions.LEDBarMode;
using MuteLEDMode = APP.DualSenseControllerOptions.MuteLEDMode;
using LinkMode = APP.JoyConDeviceOptions.LinkMode;
using JoinedGyroProvider = APP.JoyConDeviceOptions.JoinedGyroProvider;
