! function e(t, n, r) {
                ...
                return o(t, e), n(t, {
                    ...
                    render: {
                        value: function() {
                            ...
                            i.createElement("p", {style:{"whiteSpace": "pre-wrap"}}, "(1) Grab and move around red handles in a graph to customize the bezier curve or enter specific curve values in the textbox.\n(2) When you are happy with the curve, copy-paste the EASING CURVE DEFINITION values (comma separated list of 4 numbers) to a custom LS/RS/R2/L3/SA curve output options in APP application."),
                           ...
                           i.createElement("td", null,
                            ...
                            i.createElement("p", null, i.createElement("a", {
                                ...
                                target: "_blank",
                                href: "https://github.com/Ryochan7/DS4Windows/wiki/Settings"
                            }, "Click here to see APP documentation of axis curve options.")), 
                            i.createElement("p", null, i.createElement("a", {
                                style: l,
                                target: "_blank",
                                href: u.homepage + "/blob/master/example/"
                            }, "Click here to see the source code of the original Bezier-Editor created by GRE (without APP modifications).")),
                            i.createElement("text", null, "Credits go to GRE who created the concept and the first sample web app. The APP customized version of the editor webapp created by MIKA-N.")
                          )
                        }
                    }
                }), t
    ...
    182: [function(e, t) {
        t.exports = {
            name: "Bezier-easing-editor for APP (curve output of analog gamepad axis)",
            version: "0.3.3",
            ...
            author: "Author of the original beizer-curve-editor, Ga�tan Renaudeau",
            license: "ISC",
            bugs: {
