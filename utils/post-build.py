...
# run the script injecting new dependency paths to APP.deps.json
lang_script = project_dir.parent / "utils" / "inject_deps_path.py"
deps_json_path = target_dir / "APP.deps.json"
...
# rename target dir (net8.0-windows) to APP
renamed_dir = target_dir.parent / "APP"
...
zip_name = f"APP_{version}_{arch}"
