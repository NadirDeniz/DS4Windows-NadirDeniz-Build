...
namespace DS4WinWPF.DS4Forms.ViewModels
{
    public class ControllerListViewModel
    {
        ...
        {
            //IEnumerable<DS4Device> devices = APP.DS4Devices.getDS4Controllers();
    ...
    public class CompositeDeviceModel
    {
        ...
        // UI-only friendly controller type label. Uses the real InputDeviceType enum
        // (no string parsing of DisplayName). Backend data is unchanged.
        public string DeviceTypeText
        {
            get
            {
                ...
                {
                    case APP.InputDevices.InputDeviceType.DS4:
                        return "DualShock 4";
                    case APP.InputDevices.InputDeviceType.DualSense:
                        return "DualSense";
                    case APP.InputDevices.InputDeviceType.DS3:
                        return "DualShock 3";
                    case APP.InputDevices.InputDeviceType.SwitchPro:
                        return "Switch Pro Controller";
                    case APP.InputDevices.InputDeviceType.JoyConL:
                        return "Joy-Con (L)";
                    case APP.InputDevices.InputDeviceType.JoyConR:
                        return "Joy-Con (R)";
                    case APP.InputDevices.InputDeviceType.JoyConGrip:
                        return "Joy-Con Grip";
                    default:
