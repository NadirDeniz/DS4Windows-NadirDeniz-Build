...
namespace DS4WinWPF.DS4Forms
{
    ...
    public partial class WelcomeDialog : Window
    {
        ...
        public WelcomeDialog(bool loadConfig = false)
        {
            if (loadConfig)
            {
                ...
                APP.Global.Load();
                //APP.Global.SetCulture(APP.Global.UseLang);
            }
            ...
            if (!APP.Global.IsWin10OrGreater())
            {
        ...
        {
            // HidHide requires Windows 10 (or later) x64
            return APP.Global.IsWin10OrGreater() &&
        ...
        private bool IsFakerInputControlCompatible()
        {
            ...
            return APP.Global.IsWin8OrGreater();
        }
        ...
        private void ViGEmInstallTimer_Tick(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            if (monitorProc != null && monitorProc.HasExited)
            {
                ...
                if (APP.Global.IsViGEmBusInstalled())
                {
            ...
            System.Timers.ElapsedEventArgs e)
        {
            ...
            if (monitorProc != null && monitorProc.HasExited)
            {
                if (APP.Global.IsHidHideInstalled())
                {
                    Dispatcher.BeginInvoke((Action)(() =>
                    {
            ...
            System.Timers.ElapsedEventArgs e)
        {
            ...
            if (monitorProc != null && monitorProc.HasExited)
            {
                if (APP.Global.IsFakerInputInstalled())
                {
                    Dispatcher.BeginInvoke((Action)(() =>
                    {
    ...
    {
        public string PairmodePNG { get => $"{APP.Global.RESOURCES_PREFIX}/Pairmode.png"; }
    }
}
