...
Open the APPWPF.csproj file. Navigate to the Post-Build section.
...
for each locale directly next to the running executable. Since APP
...
It accepts the path to the relevant `APP.deps.json` file as a cmd argument. The script
