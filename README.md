...
APP is an extract anywhere program that allows you to get the best
...
![APP Preview](https://raw.githubusercontent.com/Ryochan7/DS4Windows/jay/ds4winwpf_screen_20200412.png)
...
APP is licensed under the terms of the GNU General Public License version 3.
...
- **[Main builds of APP](https://github.com/schmaldeo/DS4Windows/releases)**

## Install

You can install APP by downloading it from [releases](https://github.com/schmaldeo/DS4Windows/releases) and place it to your preferred place.

Alternatively, you can download [`ds4w.bat`](https://raw.githubusercontent.com/schmaldeo/DS4Windows/refs/heads/master/ds4w.bat) file and execute it. It will open a window that downloads and places the program in `%LOCALAPPDATA%\APP` and creates a desktop shortcut to the executable.
...
- [ViGEmBus](https://vigem.org/) driver (APP will install it for you)
