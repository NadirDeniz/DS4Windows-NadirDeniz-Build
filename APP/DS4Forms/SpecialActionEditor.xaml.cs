...
namespace DS4WinWPF.DS4Forms
{
    ...
    public partial class SpecialActionEditor : UserControl
    {
        ...
        public SpecialActionEditor(int deviceNum, ProfileList profileList,
            APP.SpecialAction specialAction = null)
        {
            InitializeComponent();
        ...
        private void LoadAction(APP.SpecialAction specialAction)
        {
            ...
            {
                case APP.SpecialAction.ActionTypeId.Macro:
                    macroActVM.LoadAction(specialAction);
                    break;
                case APP.SpecialAction.ActionTypeId.Program:
                    launchProgVM.LoadAction(specialAction);
                    break;
                case APP.SpecialAction.ActionTypeId.Profile:
                    loadProfileVM.LoadAction(specialAction);
                    break;
                case APP.SpecialAction.ActionTypeId.Key:
                    pressKeyVM.LoadAction(specialAction);
                    break;
                case APP.SpecialAction.ActionTypeId.DisconnectBT:
                    disconnectBtVM.LoadAction(specialAction);
                    break;
                case APP.SpecialAction.ActionTypeId.BatteryCheck:
                    checkBatteryVM.LoadAction(specialAction);
                    break;
                case APP.SpecialAction.ActionTypeId.MultiAction:
                    multiActButtonVM.LoadAction(specialAction);
                    break;
                case APP.SpecialAction.ActionTypeId.SASteeringWheelEmulationCalibrate:
                    saSteeringWheelVM.LoadAction(specialAction);
                    break;
                case APP.SpecialAction.ActionTypeId.GyroCalibrate:
        ...
        {
            APP.SpecialAction.ActionTypeId typeId = specialActVM.TypeAssoc[specialActVM.ActionTypeIndex];
            APP.SpecialAction tempAct = new APP.SpecialAction("null", "null", "null", "null");
            ...
            if (valid)
            {
                ...
                {
                    APP.Global.RemoveAction(specialActVM.SavedAction.name);
                    editMode = false;
                }
        ...
        private bool CheckActionValid(APP.SpecialAction action,
            APP.SpecialAction.ActionTypeId typeId)
        {
            bool valid = false;
            switch (typeId)
            {
        ...
        {
            APP.DS4ControlSettings settings = macroActVM.PrepareSettings();
        ...
        {
            APP.DS4ControlSettings settings = multiActButtonVM.PrepareTapSettings();
        ...
        {
            APP.DS4ControlSettings settings = multiActButtonVM.PrepareHoldSettings();
            RecordBoxWindow recordWin = new RecordBoxWindow(specialActVM.DeviceNum, settings, false);
            recordWin.Saved += (sender2, args) =>
            {
        ...
        {
            APP.DS4ControlSettings settings = multiActButtonVM.PrepareDoubleTapSettings();
            RecordBoxWindow recordWin = new RecordBoxWindow(specialActVM.DeviceNum, settings, false);
            recordWin.Saved += (sender2, args) =>
            {
        ...
        {
            APP.DS4ControlSettings settings = pressKeyVM.PrepareSettings();
