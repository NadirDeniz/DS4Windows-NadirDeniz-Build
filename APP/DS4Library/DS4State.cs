...
namespace APP
{
    public class DS4State
    {
        ...
        public bool UsePreciseStickOutput = false;
        public short PreciseLX = 0, PreciseLY = 0, PreciseRX = 0, PreciseRY = 0;
        /// <summary>Normalized stick -1..1; maintained when high-precision pipeline is active.</summary>
        public bool HasFloatNormStick = false;
        /// <summary>True 16-bit internal path active; byte sync deferred until XInput finalize.</summary>
        public bool UseTrue16BitStickPipeline = false;
        public double FloatNormLX = 0.0, FloatNormLY = 0.0, FloatNormRX = 0.0, FloatNormRY = 0.0;
        ...
        public DS4State()
        {
            ...
            UsePreciseStickOutput = false;
            PreciseLX = PreciseLY = PreciseRX = PreciseRY = 0;
            HasFloatNormStick = false;
            UseTrue16BitStickPipeline = false;
            FloatNormLX = FloatNormLY = FloatNormRX = FloatNormRY = 0.0;
        }
        ...
        public DS4State(DS4State state)
        {
            ...
            UsePreciseStickOutput = state.UsePreciseStickOutput;
            PreciseLX = state.PreciseLX;
            PreciseLY = state.PreciseLY;
            PreciseRX = state.PreciseRX;
            PreciseRY = state.PreciseRY;
            HasFloatNormStick = state.HasFloatNormStick;
            UseTrue16BitStickPipeline = state.UseTrue16BitStickPipeline;
            FloatNormLX = state.FloatNormLX;
            FloatNormLY = state.FloatNormLY;
            FloatNormRX = state.FloatNormRX;
            FloatNormRY = state.FloatNormRY;
        }
        ...
        public void CopyTo(DS4State state)
        {
            ...
            state.UsePreciseStickOutput = UsePreciseStickOutput;
            state.PreciseLX = PreciseLX;
            state.PreciseLY = PreciseLY;
            state.PreciseRX = PreciseRX;
            state.PreciseRY = PreciseRY;
            state.HasFloatNormStick = HasFloatNormStick;
            state.UseTrue16BitStickPipeline = UseTrue16BitStickPipeline;
            state.FloatNormLX = FloatNormLX;
            state.FloatNormLY = FloatNormLY;
            state.FloatNormRX = FloatNormRX;
            state.FloatNormRY = FloatNormRY;
        }
