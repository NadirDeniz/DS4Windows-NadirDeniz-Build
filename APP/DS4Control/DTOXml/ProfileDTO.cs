...
namespace DS4WinWPF.DS4Control.DTOXml
{
    ...
    public class ProfileDTO : IDTO<BackingStore>
    {
        ...
        [XmlIgnore]
        public bool CleanInputMode
        {
            get; private set;
        } = BackingStore.DEFAULT_CLEAN_INPUT_MODE;

        [XmlElement("CleanInputMode")]
        public string CleanInputModeString
        {
            get => CleanInputMode.ToString();
            set => CleanInputMode = XmlDataUtilities.StrToBool(value);
        }

        [XmlElement("CompetitiveFpsStickMode")]
        public string CompetitiveFpsStickModeString
        {
            get => CleanInputMode.ToString();
            set => CleanInputMode = XmlDataUtilities.StrToBool(value);
        }
        ...
        [XmlIgnore]
        public bool CompetitiveFpsStickMode => CleanInputMode;

        [XmlIgnore]
        public bool HighPrecisionStickOutput
        {
            get; private set;
        } = BackingStore.DEFAULT_HIGH_PRECISION_STICK_OUTPUT;

        [XmlElement("HighPrecisionStickOutput")]
        public string HighPrecisionStickOutputString
        {
            get => HighPrecisionStickOutput.ToString();
            set => HighPrecisionStickOutput = XmlDataUtilities.StrToBool(value);
        }

        [XmlIgnore]
        public int StickModifierOrder
        {
            get; private set;
        } = BackingStore.DEFAULT_STICK_MODIFIER_ORDER;

        [XmlElement("StickModifierOrder")]
        public int StickModifierOrderValue
        {
            get => StickModifierOrder;
            set => StickModifierOrder = (int)StickModifierOrderPipeline.ClampOrder(value);
        }

        [XmlIgnore]
        public bool True16BitStickPipeline
        {
            get; private set;
        } = BackingStore.DEFAULT_TRUE_16BIT_STICK_PIPELINE;

        [XmlElement("True16BitStickPipeline")]
        public string True16BitStickPipelineString
        {
            get => True16BitStickPipeline.ToString();
            set => True16BitStickPipeline = XmlDataUtilities.StrToBool(value);
        }

        [XmlElement("LSDirectionAwareResolution")]
        public string LSDirectionAwareResolutionString
        {
            get => LSDirectionAwareResolution.ToString();
            set => LSDirectionAwareResolution = XmlDataUtilities.StrToBool(value);
        }

        [XmlIgnore]
        public bool LSDirectionAwareResolution { get; private set; } =
            BackingStore.DEFAULT_DIRECTION_AWARE_RESOLUTION;

        [XmlElement("RSDirectionAwareResolution")]
        public string RSDirectionAwareResolutionString
        {
            get => RSDirectionAwareResolution.ToString();
            set => RSDirectionAwareResolution = XmlDataUtilities.StrToBool(value);
        }

        [XmlIgnore]
        public bool RSDirectionAwareResolution { get; private set; } =
            BackingStore.DEFAULT_DIRECTION_AWARE_RESOLUTION;

        [XmlElement("LSDynamicPhysicsResponse")]
        public string LSDynamicPhysicsResponseString
        {
            get => LSDynamicPhysicsResponse.ToString();
            set => LSDynamicPhysicsResponse = XmlDataUtilities.StrToBool(value);
        }

        [XmlIgnore]
        public bool LSDynamicPhysicsResponse { get; private set; } =
            BackingStore.DEFAULT_DYNAMIC_PHYSICS_RESPONSE;

        [XmlElement("RSDynamicPhysicsResponse")]
        public string RSDynamicPhysicsResponseString
        {
            get => RSDynamicPhysicsResponse.ToString();
            set => RSDynamicPhysicsResponse = XmlDataUtilities.StrToBool(value);
        }

        [XmlIgnore]
        public bool RSDynamicPhysicsResponse { get; private set; } =
            BackingStore.DEFAULT_DYNAMIC_PHYSICS_RESPONSE;

        [XmlElement("LSPredictiveJitterCleaner")]
        public string LSPredictiveJitterCleanerString
        {
            get => LSPredictiveJitterCleaner.ToString();
            set => LSPredictiveJitterCleaner = XmlDataUtilities.StrToBool(value);
        }

        [XmlIgnore]
        public bool LSPredictiveJitterCleaner { get; private set; } =
            BackingStore.DEFAULT_PREDICTIVE_JITTER_CLEANER;

        [XmlElement("RSPredictiveJitterCleaner")]
        public string RSPredictiveJitterCleanerString
        {
            get => RSPredictiveJitterCleaner.ToString();
            set => RSPredictiveJitterCleaner = XmlDataUtilities.StrToBool(value);
        }

        [XmlIgnore]
        public bool RSPredictiveJitterCleaner { get; private set; } =
            BackingStore.DEFAULT_PREDICTIVE_JITTER_CLEANER;
        ...
        [XmlElement("LSAdvancedRadialDeadzone")]
        public bool LSAdvancedRadialDeadzone { get; set; } = StickDeadZoneInfo.DEFAULT_ADVANCED_RADIAL;

        [XmlElement("RSAdvancedRadialDeadzone")]
        public bool RSAdvancedRadialDeadzone { get; set; } = StickDeadZoneInfo.DEFAULT_ADVANCED_RADIAL;

        [XmlElement("LSOuterDeadzone")]
        public int LSOuterDeadzone { get; set; } = StickDeadZoneInfo.DEFAULT_OUTER_DEADZONE;

        [XmlElement("RSOuterDeadzone")]
        public int RSOuterDeadzone { get; set; } = StickDeadZoneInfo.DEFAULT_OUTER_DEADZONE;

        [XmlElement("LSInnerZoneSoftness")]
        public double LSInnerZoneSoftness { get; set; } = StickDeadZoneInfo.DEFAULT_INNER_ZONE_SOFTNESS;

        [XmlElement("RSInnerZoneSoftness")]
        public double RSInnerZoneSoftness { get; set; } = StickDeadZoneInfo.DEFAULT_INNER_ZONE_SOFTNESS;

        [XmlElement("LSDynamicDeadzoneScaling")]
        public bool LSDynamicDeadzoneScaling { get; set; } = StickDeadZoneInfo.DEFAULT_DYNAMIC_DZ_SCALING;

        [XmlElement("RSDynamicDeadzoneScaling")]
        public bool RSDynamicDeadzoneScaling { get; set; } = StickDeadZoneInfo.DEFAULT_DYNAMIC_DZ_SCALING;

        [XmlElement("LSAdaptiveAntiDeadzone")]
        public bool LSAdaptiveAntiDeadzone { get; set; } = StickDeadZoneInfo.DEFAULT_ADAPTIVE_ANTIDEAD;

        [XmlElement("RSAdaptiveAntiDeadzone")]
        public bool RSAdaptiveAntiDeadzone { get; set; } = StickDeadZoneInfo.DEFAULT_ADAPTIVE_ANTIDEAD;

        [XmlElement("LSDynamicCenterCalibration")]
        public bool LSDynamicCenterCalibration { get; set; } = StickDeadZoneInfo.DEFAULT_DYNAMIC_CENTER_CAL;

        [XmlElement("RSDynamicCenterCalibration")]
        public bool RSDynamicCenterCalibration { get; set; } = StickDeadZoneInfo.DEFAULT_DYNAMIC_CENTER_CAL;
        ...
        private bool _rsAnalogMouseVectorEngine = AnalogMouseVectorEngineInfo.DEFAULT_ENABLED;
        [XmlElement("RSAnalogMouseVectorEngine")]
        public string RSAnalogMouseVectorEngineString
        {
            get => _rsAnalogMouseVectorEngine.ToString();
            set => _rsAnalogMouseVectorEngine = XmlDataUtilities.StrToBool(value);
        }
        public bool ShouldSerializeRSAnalogMouseVectorEngineString()
        {
            return ShouldSerializeRSAnalogMouseVectorSettings();
        }

        [XmlElement("RSAnalogMouseVectorSensitivity")]
        public double RSAnalogMouseVectorSensitivity { get; set; } =
            AnalogMouseVectorEngineInfo.DEFAULT_SENSITIVITY;
        public bool ShouldSerializeRSAnalogMouseVectorSensitivity()
        {
            return ShouldSerializeRSAnalogMouseVectorSettings();
        }

        [XmlElement("RSAnalogMouseVectorExponent")]
        public double RSAnalogMouseVectorExponent { get; set; } =
            AnalogMouseVectorEngineInfo.DEFAULT_EXPONENT;
        public bool ShouldSerializeRSAnalogMouseVectorExponent()
        {
            return ShouldSerializeRSAnalogMouseVectorSettings();
        }

        [XmlElement("RSAnalogMouseVectorDeadzone")]
        public double RSAnalogMouseVectorDeadzone { get; set; } =
            AnalogMouseVectorEngineInfo.DEFAULT_DEADZONE;
        public bool ShouldSerializeRSAnalogMouseVectorDeadzone()
        {
            return ShouldSerializeRSAnalogMouseVectorSettings();
        }

        private bool _rsAnalogMouseVectorSubpixel = AnalogMouseVectorEngineInfo.DEFAULT_SUBPIXEL;
        [XmlElement("RSAnalogMouseVectorSubpixel")]
        public string RSAnalogMouseVectorSubpixelString
        {
            get => _rsAnalogMouseVectorSubpixel.ToString();
            set => _rsAnalogMouseVectorSubpixel = XmlDataUtilities.StrToBool(value);
        }
        public bool ShouldSerializeRSAnalogMouseVectorSubpixelString()
        {
            return ShouldSerializeRSAnalogMouseVectorSettings();
        }

        [XmlElement("RSAnalogMouseVectorAngleSmoothing")]
        public double RSAnalogMouseVectorAngleSmoothing { get; set; } =
            AnalogMouseVectorEngineInfo.DEFAULT_ANGLE_SMOOTHING;
        public bool ShouldSerializeRSAnalogMouseVectorAngleSmoothing()
        {
            return ShouldSerializeRSAnalogMouseVectorSettings();
        }

        [XmlElement("RSAnalogMouseVectorVelocityBypass")]
        public double RSAnalogMouseVectorVelocityBypass { get; set; } =
            AnalogMouseVectorEngineInfo.DEFAULT_VELOCITY_BYPASS;
        public bool ShouldSerializeRSAnalogMouseVectorVelocityBypass()
        {
            return ShouldSerializeRSAnalogMouseVectorSettings();
        }

        private bool ShouldSerializeRSAnalogMouseVectorSettings()
        {
            return _rsAnalogMouseVectorEngine != AnalogMouseVectorEngineInfo.DEFAULT_ENABLED ||
                RSAnalogMouseVectorSensitivity != AnalogMouseVectorEngineInfo.DEFAULT_SENSITIVITY ||
                RSAnalogMouseVectorExponent != AnalogMouseVectorEngineInfo.DEFAULT_EXPONENT ||
                RSAnalogMouseVectorDeadzone != AnalogMouseVectorEngineInfo.DEFAULT_DEADZONE ||
                _rsAnalogMouseVectorSubpixel != AnalogMouseVectorEngineInfo.DEFAULT_SUBPIXEL ||
                RSAnalogMouseVectorAngleSmoothing != AnalogMouseVectorEngineInfo.DEFAULT_ANGLE_SMOOTHING ||
                RSAnalogMouseVectorVelocityBypass != AnalogMouseVectorEngineInfo.DEFAULT_VELOCITY_BYPASS;
        }
        ...
        private bool _lsMicroAimPrecision = MicroAimPrecisionInfo.DEFAULT_LS_ENABLED;
        [XmlElement("LSMicroAimPrecision")]
        public string LSMicroAimPrecisionString
        {
            get => _lsMicroAimPrecision.ToString();
            set => _lsMicroAimPrecision = XmlDataUtilities.StrToBool(value);
        }

        private bool _rsMicroAimPrecision = MicroAimPrecisionInfo.DEFAULT_RS_ENABLED;
        [XmlElement("RSMicroAimPrecision")]
        public string RSMicroAimPrecisionString
        {
            get => _rsMicroAimPrecision.ToString();
            set => _rsMicroAimPrecision = XmlDataUtilities.StrToBool(value);
        }

        private double _lsMicroAimPrecisionZone = MicroAimPrecisionInfo.DEFAULT_PRECISION_ZONE;
        [XmlElement("LSMicroAimPrecisionZone")]
        public double LSMicroAimPrecisionZone
        {
            get => _lsMicroAimPrecisionZone;
            set => _lsMicroAimPrecisionZone = value;
        }

        private double _rsMicroAimPrecisionZone = MicroAimPrecisionInfo.DEFAULT_PRECISION_ZONE;
        [XmlElement("RSMicroAimPrecisionZone")]
        public double RSMicroAimPrecisionZone
        {
            get => _rsMicroAimPrecisionZone;
            set => _rsMicroAimPrecisionZone = value;
        }

        private double _lsMicroAimTransitionZone = MicroAimPrecisionInfo.DEFAULT_TRANSITION_ZONE;
        [XmlElement("LSMicroAimTransitionZone")]
        public double LSMicroAimTransitionZone
        {
            get => _lsMicroAimTransitionZone;
            set => _lsMicroAimTransitionZone = value;
        }

        private double _rsMicroAimTransitionZone = MicroAimPrecisionInfo.DEFAULT_TRANSITION_ZONE;
        [XmlElement("RSMicroAimTransitionZone")]
        public double RSMicroAimTransitionZone
        {
            get => _rsMicroAimTransitionZone;
            set => _rsMicroAimTransitionZone = value;
        }

        private double _lsMicroAimPrecisionExponent = MicroAimPrecisionInfo.DEFAULT_PRECISION_EXPONENT;
        [XmlElement("LSMicroAimPrecisionExponent")]
        public double LSMicroAimPrecisionExponent
        {
            get => _lsMicroAimPrecisionExponent;
            set => _lsMicroAimPrecisionExponent = value;
        }

        private double _rsMicroAimPrecisionExponent = MicroAimPrecisionInfo.DEFAULT_PRECISION_EXPONENT;
        [XmlElement("RSMicroAimPrecisionExponent")]
        public double RSMicroAimPrecisionExponent
        {
            get => _rsMicroAimPrecisionExponent;
            set => _rsMicroAimPrecisionExponent = value;
        }

        private bool _lsDynamicStickResponse = DynamicStickResponseInfo.DEFAULT_LS_ENABLED;
        [XmlElement("LSDynamicStickResponse")]
        public string LSDynamicStickResponseString
        {
            get => _lsDynamicStickResponse.ToString();
            set => _lsDynamicStickResponse = XmlDataUtilities.StrToBool(value);
        }

        private bool _rsDynamicStickResponse = DynamicStickResponseInfo.DEFAULT_RS_ENABLED;
        [XmlElement("RSDynamicStickResponse")]
        public string RSDynamicStickResponseString
        {
            get => _rsDynamicStickResponse.ToString();
            set => _rsDynamicStickResponse = XmlDataUtilities.StrToBool(value);
        }

        private double _lsDynamicStickSlowSpeed = DynamicStickResponseInfo.DEFAULT_SLOW_SPEED;
        [XmlElement("LSDynamicStickSlowSpeed")]
        public double LSDynamicStickSlowSpeed
        {
            get => _lsDynamicStickSlowSpeed;
            set => _lsDynamicStickSlowSpeed = value;
        }

        private double _rsDynamicStickSlowSpeed = DynamicStickResponseInfo.DEFAULT_SLOW_SPEED;
        [XmlElement("RSDynamicStickSlowSpeed")]
        public double RSDynamicStickSlowSpeed
        {
            get => _rsDynamicStickSlowSpeed;
            set => _rsDynamicStickSlowSpeed = value;
        }

        private double _lsDynamicStickFastSpeed = DynamicStickResponseInfo.DEFAULT_FAST_SPEED;
        [XmlElement("LSDynamicStickFastSpeed")]
        public double LSDynamicStickFastSpeed
        {
            get => _lsDynamicStickFastSpeed;
            set => _lsDynamicStickFastSpeed = value;
        }

        private double _rsDynamicStickFastSpeed = DynamicStickResponseInfo.DEFAULT_FAST_SPEED;
        [XmlElement("RSDynamicStickFastSpeed")]
        public double RSDynamicStickFastSpeed
        {
            get => _rsDynamicStickFastSpeed;
            set => _rsDynamicStickFastSpeed = value;
        }

        private bool _lsTmrHallStickMode = TmrHallStickInfo.DEFAULT_LS_ENABLED;
        [XmlElement("LSTmrHallStickMode")]
        public string LSTmrHallStickModeString
        {
            get => _lsTmrHallStickMode.ToString();
            set => _lsTmrHallStickMode = XmlDataUtilities.StrToBool(value);
        }

        private bool _rsTmrHallStickMode = TmrHallStickInfo.DEFAULT_RS_ENABLED;
        [XmlElement("RSTmrHallStickMode")]
        public string RSTmrHallStickModeString
        {
            get => _rsTmrHallStickMode.ToString();
            set => _rsTmrHallStickMode = XmlDataUtilities.StrToBool(value);
        }

        private double _lsTmrHallJitterThreshold = TmrHallStickInfo.DEFAULT_BASE_JITTER_THRESHOLD;
        [XmlElement("LSTmrHallJitterThreshold")]
        public double LSTmrHallJitterThreshold
        {
            get => _lsTmrHallJitterThreshold;
            set => _lsTmrHallJitterThreshold = value;
        }

        private double _rsTmrHallJitterThreshold = TmrHallStickInfo.DEFAULT_BASE_JITTER_THRESHOLD;
        [XmlElement("RSTmrHallJitterThreshold")]
        public double RSTmrHallJitterThreshold
        {
            get => _rsTmrHallJitterThreshold;
            set => _rsTmrHallJitterThreshold = value;
        }

        private bool _rsSoftAntiDeadzone = SoftAntiDeadzoneInfo.DEFAULT_ENABLED;
        [XmlElement("RSSoftAntiDeadzone")]
        public string RSSoftAntiDeadzoneString
        {
            get => _rsSoftAntiDeadzone.ToString();
            set => _rsSoftAntiDeadzone = XmlDataUtilities.StrToBool(value);
        }

        private int _rsSoftAntiDeadzoneSize = SoftAntiDeadzoneInfo.DEFAULT_COMPENSATION_SIZE;
        [XmlElement("RSSoftAntiDeadzoneSize")]
        public int RSSoftAntiDeadzoneSize
        {
            get => _rsSoftAntiDeadzoneSize;
            set => _rsSoftAntiDeadzoneSize = value;
        }

        private double _rsSoftAntiDeadzoneRamp = SoftAntiDeadzoneInfo.DEFAULT_RAMP_ZONE;
        [XmlElement("RSSoftAntiDeadzoneRamp")]
        public double RSSoftAntiDeadzoneRamp
        {
            get => _rsSoftAntiDeadzoneRamp;
            set => _rsSoftAntiDeadzoneRamp = value;
        }

        private double _rsSoftAntiDeadzoneExponent = SoftAntiDeadzoneInfo.DEFAULT_EXPONENT;
        [XmlElement("RSSoftAntiDeadzoneExponent")]
        public double RSSoftAntiDeadzoneExponent
        {
            get => _rsSoftAntiDeadzoneExponent;
            set => _rsSoftAntiDeadzoneExponent = value;
        }

        private bool _rsInGameDeadzoneRemapper = InGameDeadzoneRemapperInfo.DEFAULT_ENABLED;
        [XmlElement("RSInGameDeadzoneRemapper")]
        public string RSInGameDeadzoneRemapperString
        {
            get => _rsInGameDeadzoneRemapper.ToString();
            set => _rsInGameDeadzoneRemapper = XmlDataUtilities.StrToBool(value);
        }

        private double _rsInGameDeadzoneSize = InGameDeadzoneRemapperInfo.DEFAULT_GAME_DEADZONE_SIZE;
        [XmlElement("RSInGameDeadzoneSize")]
        public double RSInGameDeadzoneSize
        {
            get => _rsInGameDeadzoneSize;
            set => _rsInGameDeadzoneSize = value;
        }

        private double _rsInGameDeadzoneExponent = InGameDeadzoneRemapperInfo.DEFAULT_EXPONENT;
        [XmlElement("RSInGameDeadzoneExponent")]
        public double RSInGameDeadzoneExponent
        {
            get => _rsInGameDeadzoneExponent;
            set => _rsInGameDeadzoneExponent = value;
        }

        private bool _rsInGameDeadzoneSoftEntry = InGameDeadzoneRemapperInfo.DEFAULT_SOFT_ENTRY;
        [XmlElement("RSInGameDeadzoneSoftEntry")]
        public string RSInGameDeadzoneSoftEntryString
        {
            get => _rsInGameDeadzoneSoftEntry.ToString();
            set => _rsInGameDeadzoneSoftEntry = XmlDataUtilities.StrToBool(value);
        }

        private double _rsInGameDeadzoneEntryRange = InGameDeadzoneRemapperInfo.DEFAULT_ENTRY_RANGE;
        [XmlElement("RSInGameDeadzoneEntryRange")]
        public double RSInGameDeadzoneEntryRange
        {
            get => _rsInGameDeadzoneEntryRange;
            set => _rsInGameDeadzoneEntryRange = value;
        }

        private bool _rsMicroVelocityQuantizationSmoother =
            MicroVelocityQuantizationSmootherInfo.DEFAULT_ENABLED;
        [XmlElement("RSMicroVelocityQuantizationSmoother")]
        public string RSMicroVelocityQuantizationSmootherString
        {
            get => _rsMicroVelocityQuantizationSmoother.ToString();
            set => _rsMicroVelocityQuantizationSmoother = XmlDataUtilities.StrToBool(value);
        }

        private double _rsMicroVelocitySmootherStrength =
            MicroVelocityQuantizationSmootherInfo.DEFAULT_STRENGTH;
        [XmlElement("RSMicroVelocitySmootherStrength")]
        public double RSMicroVelocitySmootherStrength
        {
            get => _rsMicroVelocitySmootherStrength;
            set => _rsMicroVelocitySmootherStrength = value;
        }

        private double _rsMicroVelocitySmootherRange =
            MicroVelocityQuantizationSmootherInfo.DEFAULT_RANGE;
        [XmlElement("RSMicroVelocitySmootherRange")]
        public double RSMicroVelocitySmootherRange
        {
            get => _rsMicroVelocitySmootherRange;
            set => _rsMicroVelocitySmootherRange = value;
        }

        private bool _lsSoftCenterExit = SoftCenterExitInfo.DEFAULT_ENABLED;
        [XmlElement("LSSoftCenterExit")]
        public string LSSoftCenterExitString
        {
            get => _lsSoftCenterExit.ToString();
            set => _lsSoftCenterExit = XmlDataUtilities.StrToBool(value);
        }

        private bool _rsSoftCenterExit = SoftCenterExitInfo.DEFAULT_ENABLED;
        [XmlElement("RSSoftCenterExit")]
        public string RSSoftCenterExitString
        {
            get => _rsSoftCenterExit.ToString();
            set => _rsSoftCenterExit = XmlDataUtilities.StrToBool(value);
        }

        private double _lsSoftCenterExitRange = SoftCenterExitInfo.DEFAULT_RANGE;
        [XmlElement("LSSoftCenterExitRange")]
        public double LSSoftCenterExitRange
        {
            get => _lsSoftCenterExitRange;
            set => _lsSoftCenterExitRange = value;
        }

        private double _rsSoftCenterExitRange = SoftCenterExitInfo.DEFAULT_RANGE;
        [XmlElement("RSSoftCenterExitRange")]
        public double RSSoftCenterExitRange
        {
            get => _rsSoftCenterExitRange;
            set => _rsSoftCenterExitRange = value;
        }

        private double _lsSoftCenterExitExponent = SoftCenterExitInfo.DEFAULT_EXPONENT;
        [XmlElement("LSSoftCenterExitExponent")]
        public double LSSoftCenterExitExponent
        {
            get => _lsSoftCenterExitExponent;
            set => _lsSoftCenterExitExponent = value;
        }

        private double _rsSoftCenterExitExponent = SoftCenterExitInfo.DEFAULT_EXPONENT;
        [XmlElement("RSSoftCenterExitExponent")]
        public double RSSoftCenterExitExponent
        {
            get => _rsSoftCenterExitExponent;
            set => _rsSoftCenterExitExponent = value;
        }

        private double _lsSoftCenterExitVelocityBypass = SoftCenterExitInfo.DEFAULT_VELOCITY_BYPASS;
        /// <summary>Legacy load-only. Hermite SCE ignores this; not serialized on save.</summary>
        [XmlElement("LSSoftCenterExitVelocityBypass")]
        public double LSSoftCenterExitVelocityBypass
        {
            get => _lsSoftCenterExitVelocityBypass;
            set => _lsSoftCenterExitVelocityBypass = value;
        }
        public bool ShouldSerializeLSSoftCenterExitVelocityBypass() => false;

        private double _rsSoftCenterExitVelocityBypass = SoftCenterExitInfo.DEFAULT_VELOCITY_BYPASS;
        /// <summary>Legacy load-only. Hermite SCE ignores this; not serialized on save.</summary>
        [XmlElement("RSSoftCenterExitVelocityBypass")]
        public double RSSoftCenterExitVelocityBypass
        {
            get => _rsSoftCenterExitVelocityBypass;
            set => _rsSoftCenterExitVelocityBypass = value;
        }
        public bool ShouldSerializeRSSoftCenterExitVelocityBypass() => false;
        ...
        public APP.InputDevices.TriggerEffects L2TriggerEffect
        {
            get; set;
        }

        [XmlElement("R2TriggerEffect")]
        public APP.InputDevices.TriggerEffects R2TriggerEffect
        {
            get; set;
        }
        ...
        public void MapFrom(BackingStore source)
        {
            ...
            CleanInputMode = source.cleanInputMode[deviceIndex];
            HighPrecisionStickOutput = source.highPrecisionStickOutput[deviceIndex];
            StickModifierOrderValue = source.stickModifierOrder[deviceIndex];
            True16BitStickPipeline = source.true16BitStickPipeline[deviceIndex];
            LSDirectionAwareResolution = source.lsDirectionAwareResolution[deviceIndex];
            RSDirectionAwareResolution = source.rsDirectionAwareResolution[deviceIndex];
            LSDynamicPhysicsResponse = source.lsDynamicPhysicsResponse[deviceIndex];
            RSDynamicPhysicsResponse = source.rsDynamicPhysicsResponse[deviceIndex];
            LSPredictiveJitterCleaner = source.lsPredictiveJitterCleaner[deviceIndex];
            RSPredictiveJitterCleaner = source.rsPredictiveJitterCleaner[deviceIndex];
            ...
            _rsAnalogMouseVectorEngine = source.rsAnalogMouseVectorEngineInfos[deviceIndex].enabled;
            RSAnalogMouseVectorSensitivity = source.rsAnalogMouseVectorEngineInfos[deviceIndex].sensitivity;
            RSAnalogMouseVectorExponent = source.rsAnalogMouseVectorEngineInfos[deviceIndex].exponent;
            RSAnalogMouseVectorDeadzone = source.rsAnalogMouseVectorEngineInfos[deviceIndex].deadzone;
            _rsAnalogMouseVectorSubpixel = source.rsAnalogMouseVectorEngineInfos[deviceIndex].subpixel;
            RSAnalogMouseVectorAngleSmoothing = source.rsAnalogMouseVectorEngineInfos[deviceIndex].angleSmoothing;
            RSAnalogMouseVectorVelocityBypass = source.rsAnalogMouseVectorEngineInfos[deviceIndex].velocityBypass;
            ...
            LSAdvancedRadialDeadzone = source.lsModInfo[deviceIndex].advancedRadialProcessing;
            LSOuterDeadzone = source.lsModInfo[deviceIndex].outerDeadzone;
            LSInnerZoneSoftness = source.lsModInfo[deviceIndex].innerZoneSoftness;
            LSDynamicDeadzoneScaling = source.lsModInfo[deviceIndex].dynamicDeadzoneScaling;
            LSAdaptiveAntiDeadzone = source.lsModInfo[deviceIndex].adaptiveAntiDeadzone;
            LSDynamicCenterCalibration = source.lsModInfo[deviceIndex].dynamicCenterCalibration;
            LSAxialDeadOptions = new StickAxialDeadOptionsSerializer()
            {
            ...
            RSAdvancedRadialDeadzone = source.rsModInfo[deviceIndex].advancedRadialProcessing;
            RSOuterDeadzone = source.rsModInfo[deviceIndex].outerDeadzone;
            RSInnerZoneSoftness = source.rsModInfo[deviceIndex].innerZoneSoftness;
            RSDynamicDeadzoneScaling = source.rsModInfo[deviceIndex].dynamicDeadzoneScaling;
            RSAdaptiveAntiDeadzone = source.rsModInfo[deviceIndex].adaptiveAntiDeadzone;
            RSDynamicCenterCalibration = source.rsModInfo[deviceIndex].dynamicCenterCalibration;
            RSAxialDeadOptions = new StickAxialDeadOptionsSerializer()
            {
            ...
            _lsMicroAimPrecision = source.lsMicroAimPrecisionInfo[deviceIndex].enabled;
            _rsMicroAimPrecision = source.rsMicroAimPrecisionInfo[deviceIndex].enabled;
            LSMicroAimPrecisionZone = source.lsMicroAimPrecisionInfo[deviceIndex].precisionZone;
            RSMicroAimPrecisionZone = source.rsMicroAimPrecisionInfo[deviceIndex].precisionZone;
            LSMicroAimTransitionZone = source.lsMicroAimPrecisionInfo[deviceIndex].transitionZone;
            RSMicroAimTransitionZone = source.rsMicroAimPrecisionInfo[deviceIndex].transitionZone;
            LSMicroAimPrecisionExponent = source.lsMicroAimPrecisionInfo[deviceIndex].precisionExponent;
            RSMicroAimPrecisionExponent = source.rsMicroAimPrecisionInfo[deviceIndex].precisionExponent;
            _lsDynamicStickResponse = source.lsDynamicStickResponseInfo[deviceIndex].enabled;
            _rsDynamicStickResponse = source.rsDynamicStickResponseInfo[deviceIndex].enabled;
            LSDynamicStickSlowSpeed = source.lsDynamicStickResponseInfo[deviceIndex].slowSpeedThreshold;
            RSDynamicStickSlowSpeed = source.rsDynamicStickResponseInfo[deviceIndex].slowSpeedThreshold;
            LSDynamicStickFastSpeed = source.lsDynamicStickResponseInfo[deviceIndex].fastSpeedThreshold;
            RSDynamicStickFastSpeed = source.rsDynamicStickResponseInfo[deviceIndex].fastSpeedThreshold;
            _lsTmrHallStickMode = source.lsTmrHallStickInfo[deviceIndex].enabled;
            _rsTmrHallStickMode = source.rsTmrHallStickInfo[deviceIndex].enabled;
            LSTmrHallJitterThreshold = source.lsTmrHallStickInfo[deviceIndex].baseJitterThreshold;
            RSTmrHallJitterThreshold = source.rsTmrHallStickInfo[deviceIndex].baseJitterThreshold;
            _rsSoftAntiDeadzone = source.rsSoftAntiDeadzoneInfo[deviceIndex].enabled;
            RSSoftAntiDeadzoneSize = source.rsSoftAntiDeadzoneInfo[deviceIndex].compensationSize;
            RSSoftAntiDeadzoneRamp = source.rsSoftAntiDeadzoneInfo[deviceIndex].rampZone;
            RSSoftAntiDeadzoneExponent = source.rsSoftAntiDeadzoneInfo[deviceIndex].exponent;
            _rsInGameDeadzoneRemapper = source.rsInGameDeadzoneRemapperInfo[deviceIndex].enabled;
            RSInGameDeadzoneSize = source.rsInGameDeadzoneRemapperInfo[deviceIndex].gameDeadzoneSize;
            RSInGameDeadzoneExponent = source.rsInGameDeadzoneRemapperInfo[deviceIndex].exponent;
            _rsInGameDeadzoneSoftEntry = source.rsInGameDeadzoneRemapperInfo[deviceIndex].softEntry;
            RSInGameDeadzoneEntryRange = source.rsInGameDeadzoneRemapperInfo[deviceIndex].entryRange;
            _rsMicroVelocityQuantizationSmoother =
                source.rsMicroVelocityQuantizationSmootherInfo[deviceIndex].enabled;
            RSMicroVelocitySmootherStrength =
                source.rsMicroVelocityQuantizationSmootherInfo[deviceIndex].strength;
            RSMicroVelocitySmootherRange =
                source.rsMicroVelocityQuantizationSmootherInfo[deviceIndex].range;
            _lsSoftCenterExit = source.lsSoftCenterExitInfo[deviceIndex].enabled;
            _rsSoftCenterExit = source.rsSoftCenterExitInfo[deviceIndex].enabled;
            LSSoftCenterExitRange = source.lsSoftCenterExitInfo[deviceIndex].range;
            RSSoftCenterExitRange = source.rsSoftCenterExitInfo[deviceIndex].range;
            LSSoftCenterExitExponent = source.lsSoftCenterExitInfo[deviceIndex].exponent;
            RSSoftCenterExitExponent = source.rsSoftCenterExitInfo[deviceIndex].exponent;
            LSSoftCenterExitVelocityBypass = source.lsSoftCenterExitInfo[deviceIndex].velocityBypass;
            RSSoftCenterExitVelocityBypass = source.rsSoftCenterExitInfo[deviceIndex].velocityBypass;
        ...
        public void MapTo(BackingStore destination)
        {
            ...
            destination.cleanInputMode[deviceIndex] = CleanInputMode;
            destination.highPrecisionStickOutput[deviceIndex] = HighPrecisionStickOutput;
            destination.stickModifierOrder[deviceIndex] = StickModifierOrder;
            destination.true16BitStickPipeline[deviceIndex] = True16BitStickPipeline;
            destination.lsDirectionAwareResolution[deviceIndex] = LSDirectionAwareResolution;
            destination.rsDirectionAwareResolution[deviceIndex] = RSDirectionAwareResolution;
            destination.lsDynamicPhysicsResponse[deviceIndex] = LSDynamicPhysicsResponse;
            destination.rsDynamicPhysicsResponse[deviceIndex] = RSDynamicPhysicsResponse;
            destination.lsPredictiveJitterCleaner[deviceIndex] = LSPredictiveJitterCleaner;
            destination.rsPredictiveJitterCleaner[deviceIndex] = RSPredictiveJitterCleaner;
            ...
            destination.rsAnalogMouseVectorEngineInfos[deviceIndex].enabled = _rsAnalogMouseVectorEngine;
            destination.rsAnalogMouseVectorEngineInfos[deviceIndex].sensitivity = RSAnalogMouseVectorSensitivity;
            destination.rsAnalogMouseVectorEngineInfos[deviceIndex].exponent = RSAnalogMouseVectorExponent;
            destination.rsAnalogMouseVectorEngineInfos[deviceIndex].deadzone = RSAnalogMouseVectorDeadzone;
            destination.rsAnalogMouseVectorEngineInfos[deviceIndex].subpixel = _rsAnalogMouseVectorSubpixel;
            destination.rsAnalogMouseVectorEngineInfos[deviceIndex].angleSmoothing = RSAnalogMouseVectorAngleSmoothing;
            destination.rsAnalogMouseVectorEngineInfos[deviceIndex].velocityBypass = RSAnalogMouseVectorVelocityBypass;
            ...
            destination.lsModInfo[deviceIndex].advancedRadialProcessing = LSAdvancedRadialDeadzone;
            destination.lsModInfo[deviceIndex].outerDeadzone = LSOuterDeadzone;
            destination.lsModInfo[deviceIndex].innerZoneSoftness = LSInnerZoneSoftness;
            destination.lsModInfo[deviceIndex].dynamicDeadzoneScaling = LSDynamicDeadzoneScaling;
            destination.lsModInfo[deviceIndex].adaptiveAntiDeadzone = LSAdaptiveAntiDeadzone;
            destination.lsModInfo[deviceIndex].dynamicCenterCalibration = LSDynamicCenterCalibration;
            ...
            destination.rsModInfo[deviceIndex].advancedRadialProcessing = RSAdvancedRadialDeadzone;
            destination.rsModInfo[deviceIndex].outerDeadzone = RSOuterDeadzone;
            destination.rsModInfo[deviceIndex].innerZoneSoftness = RSInnerZoneSoftness;
            destination.rsModInfo[deviceIndex].dynamicDeadzoneScaling = RSDynamicDeadzoneScaling;
            destination.rsModInfo[deviceIndex].adaptiveAntiDeadzone = RSAdaptiveAntiDeadzone;
            destination.rsModInfo[deviceIndex].dynamicCenterCalibration = RSDynamicCenterCalibration;
            ...
            if (!string.IsNullOrEmpty(Sensitivity))
            {
                ...
                if (s.Length > 0 && double.TryParse(s[0], out double temp))
                {
                    destination.LSSens[deviceIndex] = Math.Clamp(temp, 0.1, 5.0);
                }

                if (s.Length > 1 && double.TryParse(s[1], out double tempRSSens))
                {
                    destination.RSSens[deviceIndex] = Math.Clamp(tempRSSens, 0.1, 5.0);
                }

                if (s.Length > 2 && double.TryParse(s[2], out double tempL2Sens))
                {
                    destination.l2Sens[deviceIndex] = Math.Clamp(tempL2Sens, 0.1, 10.0);
                }

                if (s.Length > 3 && double.TryParse(s[3], out double tempR2Sens))
                {
                    destination.r2Sens[deviceIndex] = Math.Clamp(tempR2Sens, 0.1, 10.0);
                }

                if (s.Length > 4 && double.TryParse(s[4], out double tempSXSens))
                {
                    destination.SXSens[deviceIndex] = Math.Clamp(tempSXSens, 0.0, 5.0);
                }

                if (s.Length > 5 && double.TryParse(s[5], out double tempSZSens))
                {
            ...
            destination.lsMicroAimPrecisionInfo[deviceIndex].enabled = _lsMicroAimPrecision;
            destination.rsMicroAimPrecisionInfo[deviceIndex].enabled = _rsMicroAimPrecision;
            destination.lsMicroAimPrecisionInfo[deviceIndex].precisionZone = LSMicroAimPrecisionZone;
            destination.rsMicroAimPrecisionInfo[deviceIndex].precisionZone = RSMicroAimPrecisionZone;
            destination.lsMicroAimPrecisionInfo[deviceIndex].transitionZone = LSMicroAimTransitionZone;
            destination.rsMicroAimPrecisionInfo[deviceIndex].transitionZone = RSMicroAimTransitionZone;
            destination.lsMicroAimPrecisionInfo[deviceIndex].precisionExponent = LSMicroAimPrecisionExponent;
            destination.rsMicroAimPrecisionInfo[deviceIndex].precisionExponent = RSMicroAimPrecisionExponent;
            destination.lsDynamicStickResponseInfo[deviceIndex].enabled = _lsDynamicStickResponse;
            destination.rsDynamicStickResponseInfo[deviceIndex].enabled = _rsDynamicStickResponse;
            destination.lsDynamicStickResponseInfo[deviceIndex].slowSpeedThreshold = LSDynamicStickSlowSpeed;
            destination.rsDynamicStickResponseInfo[deviceIndex].slowSpeedThreshold = RSDynamicStickSlowSpeed;
            destination.lsDynamicStickResponseInfo[deviceIndex].fastSpeedThreshold = LSDynamicStickFastSpeed;
            destination.rsDynamicStickResponseInfo[deviceIndex].fastSpeedThreshold = RSDynamicStickFastSpeed;
            destination.lsTmrHallStickInfo[deviceIndex].enabled = _lsTmrHallStickMode;
            destination.rsTmrHallStickInfo[deviceIndex].enabled = _rsTmrHallStickMode;
            destination.lsTmrHallStickInfo[deviceIndex].baseJitterThreshold = LSTmrHallJitterThreshold;
            destination.rsTmrHallStickInfo[deviceIndex].baseJitterThreshold = RSTmrHallJitterThreshold;
            destination.rsSoftAntiDeadzoneInfo[deviceIndex].enabled = _rsSoftAntiDeadzone;
            destination.rsSoftAntiDeadzoneInfo[deviceIndex].compensationSize = RSSoftAntiDeadzoneSize;
            destination.rsSoftAntiDeadzoneInfo[deviceIndex].rampZone = RSSoftAntiDeadzoneRamp;
            destination.rsSoftAntiDeadzoneInfo[deviceIndex].exponent = RSSoftAntiDeadzoneExponent;
            destination.rsInGameDeadzoneRemapperInfo[deviceIndex].enabled = _rsInGameDeadzoneRemapper;
            destination.rsInGameDeadzoneRemapperInfo[deviceIndex].gameDeadzoneSize = RSInGameDeadzoneSize;
            destination.rsInGameDeadzoneRemapperInfo[deviceIndex].exponent = RSInGameDeadzoneExponent;
            destination.rsInGameDeadzoneRemapperInfo[deviceIndex].softEntry = _rsInGameDeadzoneSoftEntry;
            destination.rsInGameDeadzoneRemapperInfo[deviceIndex].entryRange = RSInGameDeadzoneEntryRange;
            destination.rsMicroVelocityQuantizationSmootherInfo[deviceIndex].enabled =
                _rsMicroVelocityQuantizationSmoother;
            destination.rsMicroVelocityQuantizationSmootherInfo[deviceIndex].strength =
                RSMicroVelocitySmootherStrength;
            destination.rsMicroVelocityQuantizationSmootherInfo[deviceIndex].range =
                RSMicroVelocitySmootherRange;
            destination.lsSoftCenterExitInfo[deviceIndex].enabled = _lsSoftCenterExit;
            destination.rsSoftCenterExitInfo[deviceIndex].enabled = _rsSoftCenterExit;
            destination.lsSoftCenterExitInfo[deviceIndex].range = LSSoftCenterExitRange;
            destination.rsSoftCenterExitInfo[deviceIndex].range = RSSoftCenterExitRange;
            destination.lsSoftCenterExitInfo[deviceIndex].exponent = LSSoftCenterExitExponent;
            destination.rsSoftCenterExitInfo[deviceIndex].exponent = RSSoftCenterExitExponent;
            destination.lsSoftCenterExitInfo[deviceIndex].velocityBypass = LSSoftCenterExitVelocityBypass;
            destination.rsSoftCenterExitInfo[deviceIndex].velocityBypass = RSSoftCenterExitVelocityBypass;
    ...
    public class TouchpadMouseStickSerializer
    {
        ...
        public int Rotation
        {
            get => (int)(_rotationRad * 180.0 / Math.PI);
